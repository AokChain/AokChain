...
static void SetupAokChainTxArgs()
{
...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || HelpRequested(gArgs)) {
        ...
        std::string strUsage = PACKAGE_NAME " aokchain-tx utility version " + FormatFullVersion() + "\n\n" +
            "Usage:  aokchain-tx [options] <hex-tx> [commands]  Update hex-encoded aokchain transaction\n" +
            "or:     aokchain-tx [options] -create [commands]   Create hex-encoded aokchain transaction\n" +
            "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded aokchain transaction
