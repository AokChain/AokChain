...
static int AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc<2 || gArgs.IsArgSet("-?") || gArgs.IsArgSet("-h") || gArgs.IsArgSet("-help"))
    {
        ...
        std::string strUsage = strprintf(_("%s aokchain-tx utility version"), _(PACKAGE_NAME)) + " " + FormatFullVersion() + "\n\n" +
            _("Usage:") + "\n" +
              "  aokchain-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded aokchain transaction") + "\n" +
              "  aokchain-tx [options] -create [commands]   " + _("Create hex-encoded aokchain transaction") + "\n" +
              "\n";
