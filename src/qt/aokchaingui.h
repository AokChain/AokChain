...
#ifndef AOKCHAIN_QT_AOKCHAINGUI_H
#define AOKCHAIN_QT_AOKCHAINGUI_H
...
/**
  AokChain GUI main class. This class represents the main window of the AokChain UI. It communicates with both the client and
  wallet models to give the user an up-to-date view of the current core state.
*/
class AokChainGUI : public QMainWindow
{
    Q_OBJECT
...
public:
    ...
    explicit AokChainGUI(interfaces::Node& node, const PlatformStyle *platformStyle, const NetworkStyle *networkStyle, QWidget *parent = nullptr);
    ~AokChainGUI();
...
#endif // AOKCHAIN_QT_AOKCHAINGUI_H
