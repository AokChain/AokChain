...
//! Entry point for AokChainApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &AokChainApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for AokChainGUI tests.
void AppTests::guiTests(AokChainGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &AokChainGUI::consoleShown, this, &AppTests::consoleTests);
