...
#ifndef AOKCHAIN_QT_WALLETFRAME_H
#define AOKCHAIN_QT_WALLETFRAME_H
 ...
 * controls into AokChainGUI. The purpose of this class is to allow future
 * refinements of the wallet controls with minimal need for further
 * modifications to AokChainGUI, thus greatly simplifying merges while
