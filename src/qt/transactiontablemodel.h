...
private:
    ...
    QString formatTxAmount(const TransactionRecord *wtx, bool showUnconfirmed=true, AokChainUnits::SeparatorStyle separators=AokChainUnits::separatorStandard) const;
...
#endif // AOKCHAIN_QT_TRANSACTIONTABLEMODEL_H
