...
/** AokChain unit definitions. Encapsulates parsing and formatting
   and serves as list model for drop-down selection boxes.
*/
class AokChainUnits: public QAbstractListModel
{
    Q_OBJECT

public:
    explicit AokChainUnits(QObject *parent);

    /** AokChain units.
      @note Source: https://en.aokchain.it/wiki/Units . Please add only sensible ones
     */
    enum Unit
    {
        AOK,
...
typedef AokChainUnits::Unit AokChainUnit;

#endif // AOKCHAIN_QT_AOKCHAINUNITS_H
