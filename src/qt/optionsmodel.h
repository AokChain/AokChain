...
#ifndef AOKCHAIN_QT_OPTIONSMODEL_H
#define AOKCHAIN_QT_OPTIONSMODEL_H
...
/** Interface from Qt to configuration data structure for AokChain client.
...
public:
    ...
    enum OptionID {
        ...
        ProxyIPTor,             // QString
        ProxyPortTor,           // int
        DisplayUnit,            // AokChainUnits::Unit
...
#endif // AOKCHAIN_QT_OPTIONSMODEL_H
