    ...
    mapper(nullptr)
{
    ...
    ui->aokchainAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->aokchainAtStartup);
    ...
    ui->aokchainAtStartup->setToolTip(ui->aokchainAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->aokchainAtStartup->setText(ui->aokchainAtStartup->text().arg(PACKAGE_NAME));

    ui->openAokChainConfButton->setToolTip(ui->openAokChainConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new AokChainUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->aokchainAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openAokChainConfButton_clicked()
{
