        ...
        throw std::runtime_error(
            RPCHelpMan{"generatetoaddress",
                "\nMine blocks immediately to a specified address (before the RPC call returns)\n",
                {
                    ...
                    {"address", RPCArg::Type::STR, RPCArg::Optional::NO, "The address to send the newly generated aokchain to."},
            ...
            + "If you are running the aokchain core wallet, you can get a new address to send the newly generated aokchain to with:\n"
...
static UniValue submitblock(const JSONRPCRequest& request)
{
    ...
    bool accepted = ProcessNewBlock(Params(), blockptr, /* fForceProcessing */ true, /* fNewBlock */ &new_block, hash);
