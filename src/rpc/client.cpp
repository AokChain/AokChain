...
static const CRPCConvertParam vRPCConvertParams[] =
{
    ...
    { "transfer", 1, "qty"},
    { "transfermany", 1, "amounts" },
    { "transfermanyoutputs", 0, "outputs" },
    { "transferfrom", 2, "qty"},
    { "transferfrom", 4, "token_lock_time"},
    { "transferfromaddress", 2, "qty"},
    { "transferfromaddress", 4, "token_lock_time"},
