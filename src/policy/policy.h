...
#ifndef AOKCHAIN_POLICY_POLICY_H
#define AOKCHAIN_POLICY_POLICY_H
...
/** Maximum possible transaction message length */
static const unsigned int MAX_MESSAGE_LEN = 120;
...
#endif // AOKCHAIN_POLICY_POLICY_H
