...
#ifndef AOKCHAIN_INTERFACES_WALLET_H
#define AOKCHAIN_INTERFACES_WALLET_H
...
public:
    ...
    virtual unsigned long long getStakeWeight() = 0;
...
struct WalletBalances
{
    ...
    bool balanceChanged(const WalletBalances& prev) const
    {
        return balance != prev.balance || unconfirmed_balance != prev.unconfirmed_balance ||
               ...
               watch_stake != prev.watch_stake || stake != prev.stake ||
               locked != prev.locked;
    }
};
...
#endif // AOKCHAIN_INTERFACES_WALLET_H
