...
#ifndef AOKCHAIN_INTERFACES_NODE_H
#define AOKCHAIN_INTERFACES_NODE_H
...
//! Top-level interface for a aokchain node (aokchaind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // AOKCHAIN_INTERFACES_NODE_H
