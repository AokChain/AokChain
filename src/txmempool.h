...
#ifndef AOKCHAIN_TXMEMPOOL_H
#define AOKCHAIN_TXMEMPOOL_H
...
public:
     ...
     * https://github.com/aokchain/aokchain/pull/14193 will fix it. No known code
     * in aokchain currently depends on second guarantee, but it is important to
