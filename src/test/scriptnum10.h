...
#ifndef AOKCHAIN_TEST_SCRIPTNUM10_H
#define AOKCHAIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from AokChain Core 0.10.0, for cross-comparison.
 */
public:
