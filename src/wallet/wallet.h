...
enum WalletFlags : uint64_t {
    ...
    //! aokchain from opening the wallet, thinking it was newly created, and
...
public:
    ...
    bool IsImmatureCoin(interfaces::Chain::Lock& locked_chain) const;
};
...
public:
    ...
    CAmount GetImmatureStakeCredit(interfaces::Chain::Lock& locked_chain, bool fUseCache=true) const;
    ...
    CAmount GetLockedCredit(interfaces::Chain::Lock& locked_chain, bool fUseCache=true) const;
