#!/usr/bin/env python3
# Copyright (c) 2015-2019 The AokChain Core developers
...
class FullBlockTest(AokChainTestFramework):
    ...
    def run_test(self):
        ...
        # Extend the b26 chain to make sure aokchaind isn't accepting b26
        ...
        # Extend the b28 chain to make sure aokchaind isn't accepting b28
        ...
        # aokchaind doesn't disconnect us for sending a bloated block, but if we subsequently
        ...
        #    Low-S and High-S values (whereas the aokchain code has custom code which does so);
