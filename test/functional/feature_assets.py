...
class AssetTest(AokChainTestFramework):
    ...
    def big_test(self):
        ...
        n0.issue("AOKCHAIN1", 1000)
        n0.issue("AOKCHAIN2", 1000)
        n0.issue("AOKCHAIN3", 1000)
        n0.generate(1)
        self.sync_all()

        n0.listassets(asset="AOKCHAIN*", verbose=False, count=2, start=-2)
        ...
        aokchain_assets = n0.listassets(asset="AOKCHAIN*", verbose=False, count=2, start=-2)
        assert_equal(len(aokchain_assets), 2)
        assert_equal(aokchain_assets[0], "AOKCHAIN2")
        assert_equal(aokchain_assets[1], "AOKCHAIN3")
        self.sync_all()
