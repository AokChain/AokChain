...
from test_framework.test_framework import AokChainTestFramework, SkipTest
...
class ZMQTest (AokChainTestFramework):
    ...
    def setup_nodes(self):
        ...
        # Check that aokchain has been built with ZMQ enabled.
