...
class TxnMallTest(AokChainTestFramework):
    ...
    def run_test(self):
        # All nodes should start with 125,000 AOK:
        ...
        # First: use raw transaction API to send 1240 AOK to node1_address,
        # but don't broadcast:
        ...
        # Create two spends using 1 50 AOK coin each
        ...
        # Node0's balance should be starting balance, plus 50AOK for another
        ...
        # Node0's total balance should be starting balance, plus 100AOK for 
