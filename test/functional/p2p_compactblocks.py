...
# TestP2PConn: A peer we use to send messages to aokchaind, and store responses.
...
class CompactBlocksTest(AokChainTestFramework):
    ...
    # This test actually causes aokchaind to (reasonably!) disconnect us, so do this last.
    ...
    # Test that aokchaind requests compact blocks when we announce new blocks
    ...
    def test_incorrect_blocktxn_response(self, node, test_node, version):
        ...
        # Note that it's possible for aokchaind to be smart enough to know we're
    ...
    def test_getblocktxn_handler(self, node, test_node, version):
        # aokchaind will not send blocktxn responses for blocks whose height is
