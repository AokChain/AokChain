...
"""Verify that starting aokchain with -h works as expected."""

from test_framework.test_framework import AokChainTestFramework
from test_framework.util import assert_equal

class HelpTest(AokChainTestFramework):
    ...
    def run_test(self):
        self.log.info("Start aokchain with -h for help text")
        ...
        self.log.info("Start aokchain with -version for version information")
        ...
        self.log.info("Start aokchaind with -fakearg to make sure it does not start")
