...
class BIP66Test(AokChainTestFramework):
    ...
    def run_test(self):
        ...
        with mininode_lock:
            ...
            # aokchaind is running with multiple script check threads. If script
            # check threads are not in use, then transaction script validation
            # happens sequentially, and aokchaind produces more specific reject
            # reasons.
