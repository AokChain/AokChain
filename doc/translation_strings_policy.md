...
This document provides guidelines for internationalization of the AokChain Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `aokchain_en.ts` remains unchanged.
